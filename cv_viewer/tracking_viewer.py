...
def render_2D(left_display, img_scale, objects, is_tracking_on):
    ...
    for obj in objects.object_list:
        if render_object(obj, is_tracking_on):
            ...
            # Display image scaled 2D bounding box # 显示图像缩放的 2D 边界框
            ...
            # Creation of the 2 horizontal lines 创建 2 条水平线
            ...
            # Creation of 2 vertical lines 创建 2 条竖直线
            ...
            # Display Object label as text 将对象标签显示为文本
            ...
            text_position = (int(top_left_corner[0]),int(top_left_corner[1]))
            ...
            # Diplay Object distance to camera as text 以文本形式显示对象到相机的距离
